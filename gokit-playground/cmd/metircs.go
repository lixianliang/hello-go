...
import (
	...
	"github.com/lixianliang/hello-go/gokit-playground/lorem-metrics"
)
...
func main() {
	...
	svc = metrics.LoggingMiddleware(logger)(svc)
	svc = metrics.Metrics(requestCount, requestLatency)(svc)
