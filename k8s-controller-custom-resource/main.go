...
import (
	...
	informers "github.com/lixianliang/hello-go/k8s-controller-custom-resource/pkg/client/informers/externalversions"
	"github.com/lixianliang/hello-go/k8s-controller-custom-resource/pkg/signals"
)
